...
def plot_dataset(x, y, title):
    ...
    '''
    plt.rcParams: This is used to customize the default settings for the plot.
    "figure.figsize" = (12, 8): This sets the default size of the figure (in inches) to 12x8.
    "lines.markersize" = 12: This sets the default marker size in plots to 12 (used for scatter plots and line markers).
    '''
